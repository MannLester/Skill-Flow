...
const styles = StyleSheet.create({
  flex: { flex: 1 },
  content: { flexGrow: 1, paddingHorizontal: contentPadding, justifyContent: 'center', overflow: 'hidden' },
  ...
  error: { color: colors.red, fontSize: 10, marginTop: 10, textAlign: 'center' },
  ...
  roleNote: { color: colors.muted, fontSize: 10, textAlign: 'center', marginTop: 12 },
