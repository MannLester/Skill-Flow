...
const items = [
  ...
  ['Does the AI Mentor use an external AI?', 'It can. When configured, prompts are sent to a temporary OpenCode Zen model. Zen may retain prompts or use them for improvement. When Zen is unavailable, the mentor is unavailable and unsent messages can be retried. Prompts and conversation history are stored in Convex Cloud. Do not share personal, confidential, or client information.'],
