...
const items = [
  ...
  ['How does verification work?', 'The student submits a fictional sample form and image. The app briefly checks the demo submission, then marks it Demo Approved automatically. It does not verify identity or contact a school. Never enter a real student ID.'],
  ['Does the AI Mentor use an external AI?', 'Yes. Prompts are sent to OpenCode Go. When the AI service is unavailable, unsent messages can be retried. Prompts and conversation history are stored in Convex Cloud. Do not share personal, confidential, or client information.'],
