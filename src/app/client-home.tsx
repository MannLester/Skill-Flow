...
const styles = StyleSheet.create({
  ...
  body: { backgroundColor: colors.white, paddingHorizontal: contentPadding, marginTop: -55, borderTopLeftRadius: 42, borderTopRightRadius: 42, paddingTop: 20 }, activeCard: { minHeight: 150, backgroundColor: colors.white, borderRadius: 17, padding: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 14, ...shadow }, activeCardBody: { flex: 1, gap: 2 }, activeTitle: { fontSize: 20 }, activeCount: { fontSize: 30, marginTop: 3 }, activeStatus: { color: colors.muted, fontSize: 13 }, activeCardIcon: { width: 72, height: 72, borderRadius: 14, backgroundColor: colors.blush, alignItems: 'center', justifyContent: 'center' },
