...
const styles = StyleSheet.create({
  activeCard: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 14 }, activeCardBody: { flex: 1, gap: 2 }, activeTitle: { fontSize: 20 }, activeCount: { fontSize: 30, marginTop: 3 }, activeStatus: { color: colors.muted, fontSize: 13 }, activeCardIcon: { width: 72, height: 72, borderRadius: 14, backgroundColor: colors.blush, alignItems: 'center', justifyContent: 'center' },
