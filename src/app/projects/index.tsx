...
const styles = StyleSheet.create({
  list: { flexGrow: 1, paddingHorizontal: contentPadding, paddingBottom: 24 }, action: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.red, borderRadius: 14, padding: 14, marginTop: 12 }, actionIcon: { width: 42, height: 42, borderRadius: 21, backgroundColor: 'rgba(255,255,255,0.2)', alignItems: 'center', justifyContent: 'center' }, actionTitle: { color: colors.white, fontSize: 14 }, actionSubtitle: { color: 'rgba(255,255,255,0.8)', fontSize: 10, marginTop: 2 }, groupTitle: { fontSize: 16, marginTop: 20, marginBottom: 7 }, postRow: { minHeight: 64, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: colors.border }, postMeta: { color: colors.muted, fontSize: 9, textTransform: 'capitalize', marginTop: 4 }, row: { minHeight: 126, flexDirection: 'row', alignItems: 'center', gap: 13, borderBottomWidth: 1, borderBottomColor: colors.border }, icon: { width: 54, height: 54, borderRadius: 12, backgroundColor: colors.blush, alignItems: 'center', justifyContent: 'center' }, title: { fontSize: 16 }, description: { color: colors.muted, fontSize: 11, lineHeight: 16, marginTop: 3 }, meta: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 9 }, status: { backgroundColor: colors.blush, borderRadius: 10, paddingHorizontal: 9, paddingVertical: 5 }, statusText: { color: colors.burgundy, fontSize: 10 }, empty: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32, paddingTop: 60 }, emptyTitle: { fontSize: 18, marginTop: 15 }, emptyText: { color: colors.muted, textAlign: 'center', fontSize: 12, lineHeight: 19, marginTop: 7 },
});
