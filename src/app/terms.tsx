  ...
  return (
    <MobilePage>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Section title="AI Mentor">When configured, the mentor sends prompts to a temporary OpenCode Zen model, which may retain prompts or use them for improvement. When Zen is unavailable, the mentor is unavailable and unsent messages can be retried. Mentor conversation history is stored in Convex Cloud. Do not share personal, confidential, or client information. The guidance is not professional, academic, or employment advice.</Section>
