  ...
  return (
    <MobilePage>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Section title="Projects and payments">Project bookings, balances, payment holds, releases, and verification are part of this academic demonstration. Ratings and in-app notifications are stored application records generated by demo activity. No real contract, payment, escrow, or transfer is created.</Section>
        <Section title="AI Mentor">The mentor sends prompts to OpenCode Go. When the AI service is unavailable, unsent messages can be retried. Mentor conversation history is stored in Convex Cloud. Do not share personal, confidential, or client information. The guidance is not professional, academic, or employment advice.</Section>
