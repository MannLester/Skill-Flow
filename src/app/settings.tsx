...
export default function SettingsScreen() {
  ...
  return <MobilePage backgroundColor={dark ? '#171717' : colors.white}><StatusBar style="light" /><AppHeader title="Settings" onBack={() => router.back()} /><ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} style={dark ? styles.darkPage : undefined} contentContainerStyle={[styles.content, { paddingBottom: Math.max(insets.bottom + 20, 30) }]}>
...
const styles = StyleSheet.create({ content: { flexGrow: 1, paddingHorizontal: contentPadding, paddingTop: 10 }, darkPage: { backgroundColor: '#171717' }, themeNotice: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#333', borderRadius: 10, padding: 11, marginTop: 14 }, section: { borderBottomWidth: 1, borderBottomColor: colors.border, paddingVertical: 20 }, darkSection: { borderBottomColor: '#444' }, sectionTitle: { fontSize: 16, marginTop: 4, marginBottom: 10 }, row: { minHeight: 52, flexDirection: 'row', alignItems: 'center', gap: 14 }, label: { flex: 1, fontSize: 14 }, value: { fontSize: 13 }, switch: { width: 47, height: 27, borderRadius: 14, backgroundColor: colors.graySwitch, justifyContent: 'center', paddingHorizontal: 3 }, switchOn: { backgroundColor: colors.green }, knob: { width: 21, height: 21, borderRadius: 11, backgroundColor: colors.white }, knobOn: { alignSelf: 'flex-end' }, reset: { marginTop: 18, minHeight: 48, alignItems: 'center', justifyContent: 'center' }, resetText: { color: colors.muted, fontSize: 13, marginBottom: 16 }, logout: { minHeight: 57, borderWidth: 1, borderColor: colors.border, borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginTop: 24 }, logoutText: { color: colors.burgundy, fontSize: 17 }, darkText: { color: colors.white }, darkCopy: { color: '#c9c9c9', fontSize: 10, flex: 1 }, darkBorder: { borderColor: '#555' } });
