...
function ProposalEmptyState() {
  return <View style={styles.empty}><Ionicons name="document-text-outline" size={52} color={colors.muted} /><AppText weight="semibold" style={{ marginTop: 12 }}>No proposals yet</AppText><AppText style={styles.muted}>Demo verified Student Designer proposals will appear here.</AppText></View>;
}
...
const styles = StyleSheet.create({ summary: { paddingHorizontal: contentPadding, paddingTop: 16 }, projectTitle: { fontSize: 19 }, muted: { color: colors.muted, fontSize: 10, marginTop: 3 }, list: { flexGrow: 1, padding: contentPadding, gap: 14 }, card: { backgroundColor: colors.background, borderRadius: 14, padding: 15, ...shadow }, person: { flexDirection: 'row', alignItems: 'center', gap: 10 }, avatar: { width: 46, height: 46, borderRadius: 23, backgroundColor: colors.blush, alignItems: 'center', justifyContent: 'center' }, verified: { flexDirection: 'row', alignItems: 'center', gap: 3 }, verifiedText: { color: colors.green, fontSize: 8 }, cover: { fontSize: 12, lineHeight: 19, marginTop: 14 }, bid: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: colors.blush, borderRadius: 10, padding: 12, marginTop: 14 }, state: { backgroundColor: colors.background, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 5 }, stateText: { color: colors.burgundy, fontSize: 8, textTransform: 'capitalize' }, actions: { flexDirection: 'row', gap: 9, marginTop: 13 }, reject: { flex: 1, minHeight: 50, borderWidth: 1, borderColor: colors.border, borderRadius: 8, alignItems: 'center', justifyContent: 'center' }, empty: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 30 } });
