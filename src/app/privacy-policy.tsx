  ...
  return (
    <MobilePage>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Section title="Simulated verification">Student Verification accepts fictional sample data and automatically marks a complete demo submission approved after a short check. It does not assess document authenticity or perform real identity verification.</Section>
        <Section title="AI Mentor">The AI Mentor sends prompts to OpenCode Go. When the AI service is unavailable, unsent messages can be retried. Prompts and conversation history are stored in Convex Cloud. Do not share personal, confidential, or client information.</Section>
