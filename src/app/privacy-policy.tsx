  ...
  return (
    <MobilePage>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Section title="AI Mentor">When configured, the AI Mentor sends prompts to a temporary OpenCode Zen model, which may retain prompts or use them for improvement. When Zen is unavailable, the mentor is unavailable and unsent messages can be retried. Prompts and conversation history are stored in Convex Cloud. Do not share personal, confidential, or client information.</Section>
