...
export default function ProjectMessagesScreen() {
  ...
  const submit = async () => { const result = await sendMessage(booking.id, body, mediaInputs(images)[0]); if (result.ok) { setBody(''); setImages([]); } };
  return (
    <MobilePage>
