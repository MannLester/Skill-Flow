...
const styles = StyleSheet.create({ header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: contentPadding }, headerTitle: { flex: 1, textAlign: 'center', fontSize: 15 }, content: { flexGrow: 1, paddingHorizontal: contentPadding, paddingTop: 28 }, form: { gap: 11, marginTop: 16 }, verify: { gap: 16, marginTop: 30 }, verifyCopy: { color: colors.muted, textAlign: 'center', fontSize: 11 }, terms: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, marginTop: 16 }, termsCopy: { flex: 1, flexDirection: 'row', flexWrap: 'wrap', gap: 3 }, checkbox: { width: 16, height: 16, borderWidth: 1.5, borderColor: '#c87379', borderRadius: 3, alignItems: 'center', justifyContent: 'center' }, checkboxActive: { backgroundColor: colors.red, borderColor: colors.red }, termsText: { fontSize: 9 }, termsLink: { color: colors.red, fontSize: 9 }, error: { color: colors.red, fontSize: 10, textAlign: 'center', marginTop: 12 } });
